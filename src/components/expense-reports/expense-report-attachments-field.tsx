...
import { getExpenseReportAttachmentPublicUrl } from '@/lib/expense-reports/attachments'
import type { ExpenseReportAttachmentFile } from '@/lib/expense-reports/types'

type ExpenseReportAttachmentsFieldProps = {
  description: string
  files: ExpenseReportAttachmentFile[]
  pendingFiles: File[]
  readOnly?: boolean
  onDescriptionChange: (value: string) => void
  onFilesChange: (files: ExpenseReportAttachmentFile[]) => void
...
export function ExpenseReportAttachmentsField({
  description,
  files,
  pendingFiles,
  readOnly = false,
...
}: ExpenseReportAttachmentsFieldProps) {
  ...
  function removeUploaded(file: ExpenseReportAttachmentFile) {
