                ...
                {dayRows.map((row) => {
                  ...
                  return (
                    <span
                      ...
                      className={`block w-full cursor-pointer rounded-md border px-1.5 py-1.5 text-[11px] leading-snug shadow-sm transition hover:brightness-95 ${scopeTone(row.scope)}`}
                    >
